...
void  OS_CPU_IntHandler (CPU_INT32U  src_id)
{
	CPU_INT32U  int_id;
	// int _SIGTRAP;
	extern int Gdb_Handle_Exception(int);
    switch (src_id) {
        ...
        case OS_CPU_ARM_EXCEPT_ABORT_PREFETCH:
        	//TODO:Define Function GDB_Execption_Handelr(EventType,GDBStatus)
        	Gdb_Handle_Exception(5);
        	//TODO: Wait till to get post Signal
